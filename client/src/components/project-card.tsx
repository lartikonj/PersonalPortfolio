...
export function ProjectCard({ project }: ProjectCardProps) {
  ...
  return (
    <Link href={`/project/${project.id}`}>
      <div className="group bg-white dark:bg-slate-800 rounded-xl shadow-md hover:shadow-xl dark:shadow-slate-900/20 transition-all duration-300 overflow-hidden border border-slate-200 dark:border-slate-700 cursor-pointer">
